  ...
  <body>
    ...
    >
      <div class="container-fluid">
        ...
        >
          <div class="navbar-nav">
            ...
            <a class='nav-link text-success' href='FrontController?accion=registrar'>Comprar tickets</a>
      ...
      >
        ...
        <h4 class="card-title textoAbajo mx-4 fs-3">Conf Bs As</h4>

        <p class="card-text centrado col-md-7 TextoDer textoAbajo"
    ...
    <div class="container-fluid">
      <div class="row justify-content-center text-white divDoble">
        <div class="col-6 d-inline ps-0">
          <img src="img/honolulu.jpg" alt="Honolulu" class="card-img-top" />
        </div>
    ...
    <div class="container-fluid text-center" px-5 style="width: 65%">
      ...
      <div class="d-grid gap-2">
        <button class="btn btn-primary bEnviar" type="button">
          Enviar
        </button>
      </div>
    </div>
    ...
    <footer class="container-fluid footer text-white pt-4">
